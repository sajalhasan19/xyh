...
"""
Helpers for histogram manipulation.
"""
...
if TYPE_CHECKING:  # pragma: no cover - optional dependency during type checking
    hist = maybe_import("hist")

logger = law.logger.get_logger(__name__)


def apply_rebinning_edges(h, axis_name: str, edges: list):
    """
    ...
    # Take is used because reduceat sums i:len(array) for the last entry; ensure the new histogram
    # keeps the same number of bins as requested.
